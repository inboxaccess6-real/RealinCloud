...
namespace RealEstate.Application.DTOs.Builders;

public record CreateBuilderRequest(
    string Name,
    Guid? CreatedByAgentId = null,
    string? Email = null, string? Phone = null,
    int? EstablishedYear = null, string? RegistrationNumber = null,
    string? HeadquartersAddress = null, string? Website = null,
    bool Active = true
);
...
public record BuilderResponse(
    ...
    int? EstablishedYear, string? RegistrationNumber,
    string? HeadquartersAddress, string? Website,
    bool Active,
